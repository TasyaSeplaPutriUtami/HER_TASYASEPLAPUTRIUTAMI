...
import com.tasya.pustakaclient.FormAnggota;
import com.tasya.pustakaclient.model.Anggota;
import com.tasya.pustakaclient.service.AnggotaService;
...
public class AnggotaController {
    ...
    public void viewTabel(){
        ...
        for(Anggota anggota : anggotaList){
            Object[]row = {
                anggota.getAnggotaId(),anggota.getNama(),anggota.getAlamat()
            };
