 ...
 */
package com.tasya.pustakaclient.controller;

import com.tasya.pustakaclient.FormPeminjaman;
import com.tasya.pustakaclient.model.Peminjaman;
import com.tasya.pustakaclient.service.PeminjamanService;
...
public class PeminjamanController {
    ...
    public void viewTabel(){
        ...
        for(Peminjaman peminjaman : peminjamanList){
            Object[]row = {
                peminjaman.getPeminjamanId(),peminjaman.getAnggotaId(),peminjaman.getBukuId(),peminjaman.getTglpinjam(),peminjaman.getTglkembali()
            };
