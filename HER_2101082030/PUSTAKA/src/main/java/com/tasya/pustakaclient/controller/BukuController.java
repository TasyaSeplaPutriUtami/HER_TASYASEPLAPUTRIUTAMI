...
import com.tasya.pustakaclient.FormBuku;
import com.tasya.pustakaclient.model.Buku;
import com.tasya.pustakaclient.service.BukuService;
...
public class BukuController {
    ...
    public void viewTabel(){
        ...
        for(Buku buku : bukuList){
            Object[]row = {
                buku.getBukuId(),buku.getKode(), buku.getJudul(),buku.getPengarang(),buku.getPenerbit(),buku.getTahunTerbit()
            };
